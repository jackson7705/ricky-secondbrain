...
def upload_file(
    ...
    Args:
        ...
        display_name: Name to use in Drive (defaults to the local filename).
        mime_type: Content MIME type (defaults to guessing from extension).

    Returns:
        DriveFile describing the uploaded file.
    """
    import mimetypes
